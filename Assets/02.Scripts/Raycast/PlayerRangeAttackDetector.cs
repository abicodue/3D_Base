...
public class PlayerRangeAttackDetector : MonoBehaviour
{
    [SerializeField]
    ...
    [SerializeField]
    private PlayerRangeHitHandler rangeHitHandler;
    ...
    public void Fire(InputAction.CallbackContext _)
    {
        ...
        if (shotResult.didHit && rangeHitHandler != null)
        {
            rangeHitHandler.HandleHit(shotResult.hit, aimResult);
        }
